...
<body>
<img src="img/produto.jpg" alt="Produtos" class="background-image">

<div class="main-container">
        <form action="" method="POST">
                            <h1>Acessar Papelaria</h1>
        ...
        <br>
        <div class="btn">
             <input name="btnenviar" type="submit" value="Acessar" style="background-color: #8104a7">
        </div>
        </form>
...
if (isset($_POST['btnenviar'])) {
    ...
    foreach ($pro_bd as $pro_mostrar) 
    {
        ...
        <br><b> 
            <?php  
            echo '<div style = "font-size: 14px;  padding: 10px; color: #BA55D3;">';
            echo "Bem-Vindo de volta " .$pro_mostrar[0]. "!";
            echo '</div>';?></b><br>
        <br>
        <div class="btn2">
        <a href="menu.html"><input type="button" value="Entrar" style="background-color: #8104a7"></a></div>
        <?php
    }
